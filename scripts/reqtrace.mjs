...
//
//	node scripts/reqtrace.mjs          rewrite TRACEABILITY.md
//	node scripts/reqtrace.mjs --check  fail if a requirement or an annotation is
...
function render(requirements) {
  ...
  out.push('<!-- Generated by scripts/reqtrace.mjs; do not edit by hand. -->');
  out.push('<!-- markdownlint-disable MD033 -->', '');
  out.push('Generated from the requirement files in this directory and the', '`Implements:` and `Verifies:` annotations in the source tree. Regenerate', 'it with `node scripts/reqtrace.mjs`.', '');
  out.push('## Summary', '');
...
if (process.argv.includes('--check')) {
  ...
  if (current !== text) fail(`${relative(ROOT, MATRIX)} is stale: run node scripts/reqtrace.mjs`);
} else {
